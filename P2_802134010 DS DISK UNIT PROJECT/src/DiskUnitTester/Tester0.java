...
public class Tester0 {
	...
	/**creates new disk units 
	 * @param args
	 * @throws ExistingDiskException 
	 * @throws InvalidParameterException 
	 * @throws NonExistingDiskException 
	 */
	public static void main(String[] args) throws InvalidParameterException, ExistingDiskException, NonExistingDiskException {
	...
	/**
	 * you will split the file and write it to the dsik 
	 * @param s the string to write and to be split
	 * @param d the disk unit where it will be written 
	 */
